...
const Data = () => {
  return (
    <div className="home__data">
      <h1 className="home__title" style={{fontSize: '25px'}}>
      ...
      <p className="home__description">
        I describe myself as passionate developer who loves coding. web development is my passion. I enjoy learning new skill daily and staying connected.
      </p>
